...
* l'applicativo consente di monitorare l'andamento di un ticker azionario (ad esempio AAPL per Apple) e confrontare le previsioni del modello con i dati reali di mercato, mostrando grafici e cosa pesa il modello in quell giorno e i 4 precedenti
